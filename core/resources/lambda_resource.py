...
from aws_connection.helper import retry
from botocore.exceptions import ClientError
from commons.log_helper import get_logger
from core import CONFIG, CONN
from core.build.meta_processor import S3_PATH_NAME
from core.helper import (create_pool, unpack_kwargs)
from core.resources.helper import build_description_obj, validate_params
from core.resources.sns_resource import create_sns_subscription_for_lambda

RESET_DESCRIPTION = 'reset'

FUNCTION_NAME = 'FunctionName'

_LOG = get_logger('core.resources.lambda_resource')
