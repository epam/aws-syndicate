...
from aws_connection import S3Connection
from botocore.exceptions import ClientError
from commons.log_helper import get_logger
from concurrent.futures import ThreadPoolExecutor
from core import CONFIG, CONN, sts
from core.build.meta_processor import (validate_deployment_packages)
from core.constants import (ARTIFACTS_FOLDER, BUILD_META_FILE_NAME,
                            DEFAULT_SEP)
from core.helper import build_path, unpack_kwargs

_S3_CONN = CONN.s3()

_LOG = get_logger('core.build.bundle_processor')
