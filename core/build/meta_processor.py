...
from core import CONFIG, S3_PATH_NAME
from core.build.helper import build_py_package_name
from core.conf.config_holder import GLOBAL_AWS_SERVICES
from core.constants import (API_GATEWAY_TYPE, ARTIFACTS_FOLDER,
                            BUILD_META_FILE_NAME, EBS_TYPE,
                            LAMBDA_CONFIG_FILE_NAME, LAMBDA_TYPE,
                            RESOURCES_FILE_NAME, RESOURCE_LIST)
from core.helper import (build_path, prettify_json, resolve_aliases_for_string,
                         write_content_to_file)
from core.resources.helper import resolve_dynamic_identifier

_LOG = get_logger('core.build.meta_processor')
