...
CLOUD_WATCH_DASHBOARD_TYPE = 'cloudwatch_dashboard'
...
UPDATE_RESOURCE_TYPE_PRIORITY = {
    ...
    LAMBDA_TYPE: 8,
    API_GATEWAY_TYPE: 9,
    API_GATEWAY_OAS_V3_TYPE: 10,
    EC2_LAUNCH_TEMPLATE_TYPE: 11,
    BATCH_JOBDEF_TYPE: 12,
    BATCH_COMPENV_TYPE: 13,
    SWAGGER_UI_TYPE: 14,
    APPSYNC_TYPE: 15,
    STEP_FUNCTION_TYPE: 16,
    CLOUD_WATCH_DASHBOARD_TYPE: 17,
    EVENT_BRIDGE_SCHEDULE_TYPE: 18,
}
...
TAGS_RESOURCE_TYPE_CONFIG = {
    ...
    'post_deploy_tagging': [
        KINESIS_STREAM_TYPE, S3_BUCKET_TYPE, API_GATEWAY_OAS_V3_TYPE
    ],
    'untaggable': [
        EVENT_BRIDGE_SCHEDULE_TYPE, SWAGGER_UI_TYPE,
        SNS_PLATFORM_APPLICATION_TYPE, LAMBDA_LAYER_TYPE
    ]
}
