...
API_GATEWAY_AUTHORIZER_TYPE = 'api_gateway_authorizer'
...
DEPLOY_RESOURCE_TYPE_PRIORITY = {
    ...
    LAMBDA_TYPE: 11,
    STATE_ACTIVITY_TYPE: 12,
    STEP_FUNCTION_TYPE: 13,
    API_GATEWAY_TYPE: 14,
    API_GATEWAY_AUTHORIZER_TYPE: 15,
    COGNITO_TYPE: 16,
    EBS_TYPE: 17,
...
CLEAN_RESOURCE_TYPE_PRIORITY = {
    ...
    STATE_ACTIVITY_TYPE: 12,
    STEP_FUNCTION_TYPE: 13,
    API_GATEWAY_AUTHORIZER_TYPE: 14,
    API_GATEWAY_TYPE: 15,
    COGNITO_TYPE: 16,
    EBS_TYPE: 17,
    EC2_INSTANCE_TYPE: 18,
