...
from syndicate.core.generators.project import (generate_project_structure,
                                               PROJECT_PROCESSORS)
from syndicate.core.helper import (check_required_param, timeit, OrderedGroup, check_bundle_bucket_name)
...
@click.option('--bundle_bucket_name',
              help='* Name of the bucket that is used for uploading artifacts.'
                   ' It will be created if specified.', required=True, callback=check_bundle_bucket_name)
