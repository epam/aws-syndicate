...
- Added support for `.NET 10` runtime for lambda functions and lambda layers

# [1.21.1] - 2026-06-25
- Added support for `python3.14` and `nodejs24.x` lambda function runtimes
- Fixed an issue related to updating the SQS queue with a redrive policy specified
